...
impl Bls12_381 {
    ...
    pub fn hash_to_g1(&self, msg: Bytes, dst: Bytes) -> Bytes {
        let env = self.env();
        let bin = internal::Env::bls12_381_hash_to_g1(env, msg.into(), dst.into()).unwrap_infallible();
        Bytes::try_from_val(env, &bin).unwrap_infallible()
    }
    ...
    pub fn hash_to_g2(&self, msg: Bytes, dst: Bytes) -> Bytes {
        let env = self.env();
        let bin = internal::Env::bls12_381_hash_to_g2(env, msg.into(), dst.into()).unwrap_infallible();
        Bytes::try_from_val(env, &bin).unwrap_infallible()
    }
